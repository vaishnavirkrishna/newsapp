...
class MyPolitics extends StatefulWidget {
  const MyPolitics({super.key});

  @override
  State<MyPolitics> createState() => _MyHomeState();
}

class _MyHomeState extends State<MyPolitics> {
  NewsApi? newsModel;
  ...
  Future<void> fetchData() async {
    ...
    var url = Uri.parse(
        "https://newsapi.org/v2/everything?q=politics&apiKey=64174d48a9ae41de96dd432d950b586e");
