...
class MyEntertainment extends StatefulWidget {
  const MyEntertainment({super.key});

  @override
  State<MyEntertainment> createState() => _MyHomeState();
}

class _MyHomeState extends State<MyEntertainment> {
  NewsApi? newsModel;
  ...
  Future<void> fetchData() async {
    ...
    var url = Uri.parse(
        "https://newsapi.org/v2/everything?q=entertainment&apiKey=64174d48a9ae41de96dd432d950b586e");
