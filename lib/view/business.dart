...
class MyBusiness extends StatefulWidget {
  ...
  @override
  State<MyBusiness> createState() => _MyHomeState();
}

class _MyHomeState extends State<MyBusiness> {
  NewsApi? newsModel;
  ...
  Future<void> fetchData() async {
    ...
    var url = Uri.parse(
        "https://newsapi.org/v2/everything?q=business&apiKey=64174d48a9ae41de96dd432d950b586e");
